...
/**
 * Important note: This is an refactorized copy from UF.java algorithm, from 
 * Princeton university, href="http://algs4.cs.princeton.edu/15uf
 */
 

public class DisjointStructures {
     ...
     */
    public DisjointStructures(int N) {
    ...
    //public static void main(String[] args) {
        //In N = In(args[0]);
        //DisjointStructures uf = new DisjointStructures(N);
        // while (!StdIn.isEmpty()) {
        //     int p = StdIn.readInt();
        //     int q = StdIn.readInt();
 ...
 *  Last updated: Sat Sep 12 21:56:02 EDT 2015.
 */